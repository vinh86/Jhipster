...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './jhipster.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JHIPSTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JHIPSTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JHIPSTER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_JHIPSTER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_JHIPSTER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JHIPSTER actions', async () => {
      const arg = 42666;
