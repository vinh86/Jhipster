...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JHIPSTERSETTING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JHIPSTERSETTING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JHIPSTERSETTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_JHIPSTERSETTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_JHIPSTERSETTING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JHIPSTERSETTING actions', async () => {
      const arg = 42666;
